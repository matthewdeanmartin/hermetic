...
readonly SRC_DIR="./hermetic"
readonly TMP_ROOT="/tmp"
readonly TMP_DIR="${TMP_ROOT}/hermetic"
readonly OUTPUT_MD_BASENAME="hermetic.flat.md"
...
# Run strip-docs for each subdirectory of tmp/hermetic
...
# in the generated Markdown (hermetic.flat.md). Other code fences remain untouched.
